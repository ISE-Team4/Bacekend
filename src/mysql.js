...
module.exports.createTable = async () => {
  try {
    ...
    let psQ =
      "CREATE TABLE IF NOT EXISTS PS (ps_id INT NOT NULL AUTO_INCREMENT PRIMARY KEY, user_id INT NOT NULL, ps_name VARCHAR(50) NOT NULL, ps_startdate DATETIME NOT NULL, ps_enddate DATETIME, ps_memo VARCHAR(500), ps_type VARCHAR(50), ps_alarm BOOLEAN NOT NULL DEFAULT TRUE, FOREIGN KEY (user_id) references User (user_id));";
    let teamQ =
    ...
    let tsQ =
      "CREATE TABLE IF NOT EXISTS TS ( ts_id INT NOT NULL AUTO_INCREMENT PRIMARY KEY, team_id INT NOT NULL, ts_name VARCHAR(50) NOT NULL, ts_startdate DATETIME NOT NULL, ts_enddate DATETIME, ts_memo VARCHAR(500),FOREIGN KEY (team_id) references Team(team_id));";
